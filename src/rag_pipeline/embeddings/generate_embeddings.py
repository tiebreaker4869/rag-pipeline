    ...
    def __getitem__(self, idx):
        ...
        for page_info in page_info_list:
            ...
            try:
                ...
                print(
                    f"Error processing page {page_info['page_num']} of {pdf_path}: {e}, using blank image"
                )
        ...
        return {
            "pdf_path": pdf_path,
            "page_num": [
                page_info["page_num"] for page_info in page_info_list
...
def main():
    parser = argparse.ArgumentParser(
        description="Process PDF documents into embeddings using accelerate"
    )
    parser.add_argument(
        "--input_dir",
        type=str,
    ...
    parser.add_argument(
        "--image_dpi", type=int, default=150, help="DPI for rendering PDF pages"
    )
    parser.add_argument(
